        ...
        <nav>
            <ul class="pager">
                <li class="previous"><a href="
                    {{ url.get(['for':'subRepository.showNoAttachment.page','page':page.before,'repository':page.repository.getModelType()]) }}
                "><span aria-hidden="true">&larr;</span> 上一页</a></li>
                <li class="next"><a href="
                    {{ url.get(['for':'subRepository.showNoAttachment.page','page':page.next,'repository':page.repository.getModelType()]) }}
        ...
        <table class="table table-hover table-layout:fixed">
            ...
            {% for row in page.items %}
                ...
                <tr>
                    ...
                    <td>{{ item.gpresent().get('linkCount') }}</td>
